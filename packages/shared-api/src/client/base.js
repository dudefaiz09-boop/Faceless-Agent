...
export class ApiClient {
    ...
    async request(path, config = {}) {
        ...
        const { params, timeout = this.config.defaultTimeout, retry = this.config.defaultRetry, retryDelay = (attempt) => Math.pow(2, attempt) * 1000, cancelToken, allowOfflineQueue, ...fetchConfig } = finalConfig;
