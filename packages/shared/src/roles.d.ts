...
export declare const ALL_MODULES: readonly [
  'dashboard',
  'aiAssistant',
  'announcements',
  'attendance',
...
export declare function toPermissionMap(
...
export declare function getEffectiveModules(
  role: string | null | undefined,
  assignedModules?: readonly string[] | null
): ModuleKey[];
export declare function canAccessModule(
  role: string | null | undefined,
  module: ModuleKey,
  assignedModules?: readonly string[] | null
): boolean;
