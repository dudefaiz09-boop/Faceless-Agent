...
describe('Advanced AI Safety & Fallback', () => {
  ...
  it('returns overload message when all free models fail', async () => {
    ...
    const result = await generateSafeContent('sys', 'Hello', {}, 2); // 3 total attempts
